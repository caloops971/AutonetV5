(function ($) {
    ...
    $('.vehicles-slider-for').slick({
        ...
        slidesToScroll: 1,
        arrows: true,
        prevArrow: '<button class="slick-prev slick-arrow d-block" aria-label="Previous" type="button" style="">Previous</button>',
        nextArrow: '<button class="slick-next slick-arrow d-block" aria-label="Next" type="button" style="">Next</button>',
        dots: false,
        variableWidth: true,
        draggable: true,
        infinite: true,
